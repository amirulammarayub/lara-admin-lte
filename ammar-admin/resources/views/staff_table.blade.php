...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="../../vendor/almasaeed2010/adminlte/index2.html" class="logo">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../../vendor/almasaeed2010/adminlte/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                            <li><a href="../../vendor/almasaeed2010/adminlte/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
