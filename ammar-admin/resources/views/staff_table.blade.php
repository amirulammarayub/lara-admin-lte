...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="http://ammar-api.test/api/" class="logo">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover">
                                    ...
                                    @php
                                        $link ="http://ammar-api.test/api/staff/".$staff->staff_id;
                                    @endphp
                                    <tr>
                                        <td>{{ $staff->staff_id }}</td>
                                        <td><a href={{ $link }}>{{ $staff->staff_name }}</a></td>
                                        <td>{{ $staff->created_at }}</td>
                                        <td>{{ $staff->staff_added_by }}</td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
                            <a href="http://ammar-api.test/api/staff/register" class="btn btn-success btn-block btn-flat">Add New Staff</a>
                            <!-- /.box-body -->
                        </div>
                        <!-- /.box -->
                    </div>
